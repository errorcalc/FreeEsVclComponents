object MainForm: TMainForm
  ...
  object EsImageLayout1: TEsImageLayout
    ...
    object EsSwitch7: TEsSwitch
      ...
      Width = 68
      Height = 20
      Colors.IsSystemColors = False
      Colors.OffNormalFillColor = claNull
      Colors.OffNormalFrameColor = xCC000000
      Colors.OffNormalThumbColor = xCC000000
      Colors.OffHotFillColor = claNull
      Colors.OffHotFrameColor = claBlack
      Colors.OffHotThumbColor = claBlack
      Colors.OffDisableFillColor = claNull
      Colors.OffDisableFrameColor = x33000000
      Colors.OffDisableThumbColor = x33000000
      Colors.OnNormalFillColor = xFF1AFF12
      Colors.OnNormalFrameColor = claNull
      Colors.OnNormalThumbColor = claWhite
      Colors.OnHotFillColor = xCC17FF0F
      Colors.OnHotFrameColor = claNull
      Colors.OnHotThumbColor = claWhite
      Colors.OnDisableFillColor = x99000000
      Colors.OnDisableFrameColor = claNull
      Colors.OnDisableThumbColor = claWhite
      Colors.DragFillColor = x994BA0AE
      Colors.DragFrameColor = claNull
      Colors.DragThumbColor = claWhite
      Checked = True
      ShowCaption = True
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clTeal
